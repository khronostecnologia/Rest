...
uses
  ...
  dxGDIPlusClasses, Vcl.ExtCtrls, cxGridLevel, cxClasses, cxGridCustomView,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxGrid,
  AdvSmoothPanel, AdvGlowButton;
...
type
  TFrmEmpresas = class(TForm)
    ...
    GridEmpresaDBTableView1: TcxGridDBTableView;
    GridEmpresaLevel1: TcxGridLevel;
    GridEmpresa: TcxGrid;
    lblTitulo: TLabel;
